      ...
      <div className="flex justify-between items-center bg-slate-50 p-3 rounded-lg border border-slate-200">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-2.5 py-1 bg-indigo-600 hover:bg-indigo-700 text-gray-900 rounded text-xs font-semibold flex items-center gap-1 transition-all"
          >
      ...
      {showEditor && (
        <div className="bg-white border-2 border-indigo-100 p-4 rounded-xl shadow-sm space-y-4 animate-fadeIn text-xs">
          <div className="flex justify-between items-center border-b pb-2 mb-2">
            ...
            {editingIndex !== null && (
              <button onClick={() => { setEditingIndex(null); }} className="text-gray-500 hover:text-slate-600">
                Cancel Form
              </button>
            )}
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 pt-1 justify-end">
                ...
                <button
                  ...
                  className="px-4 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-gray-900 rounded font-semibold"
                >
                  Save Video
                </button>
              </div>
              ...
              return (
                <button
                  ...
                  className={`w-full p-3.5 text-left border rounded-xl flex items-start gap-3 transition-all ${
                    isActive
                      ? 'bg-white border-slate-900 text-gray-900 shadow-md'
                ...
                >
                  ...
                  <div className="space-y-1.5 min-w-0">
                    ...
                    <p className={`text-[10px] line-clamp-2 ${isActive ? 'text-gray-600' : 'text-slate-500'}`}>
          ...
          <div className="md:col-span-3">
            {activeVideo ? (
              <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm flex flex-col h-full">
                ...
                <div className="bg-gray-50 aspect-video relative flex items-center justify-center">
                  {getEmbedUrl(activeVideo.url, activeVideo.title, activeVideo.description) ? (
                    ...
                    <div className="p-6 text-center text-gray-900 space-y-3">
                      ...
                      <div>
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex items-center gap-1 px-4 py-2 bg-rose-600 hover:bg-rose-700 text-gray-900 text-xs font-semibold rounded transition"
                        >
                ...
                <div className="p-4 flex-1 bg-slate-50/50 flex flex-col justify-between">
                  ...
                  <div className="pt-3 border-t border-slate-200 mt-4 flex items-center justify-between">
                    <span className="text-[10px] text-gray-500">Curated Video Resource</span>
                    <a
                      href={activeVideo.url}
                      target="_blank"
                      rel="noreferrer"

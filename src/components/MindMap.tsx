  ...
  return (
    <div id="mindmap-container" className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-white p-4 rounded-xl border border-gray-200">
      ...
      <div className="lg:col-span-2 relative overflow-auto border border-gray-100 rounded-lg bg-gray-50/50 p-2 max-h-[500px]">
        ...
        {hoveredNode && (
          <div className="absolute top-2 left-2 bg-white text-gray-900 text-xs p-3 rounded shadow-lg max-w-xs z-50 transition-opacity duration-200">
      ...
      <div className="bg-slate-50 p-4 rounded-lg border border-slate-200/60 flex flex-col justify-between">
        <div>
          <div className="flex items-center justify-between pb-3 mb-4 border-b border-slate-200">
            ...
            <button
              ...
              className="px-2 py-1 text-xs bg-emerald-600 hover:bg-emerald-700 text-gray-900 font-medium rounded flex items-center gap-1 transition-all"
            >
          ...
          {isAdding && (
            <div className="space-y-3 bg-white p-3 rounded border border-emerald-200 shadow-sm animate-fadeIn">
              <div className="flex justify-between items-center">
                ...
                <button onClick={() => setIsAdding(false)} className="text-gray-500 hover:text-slate-600">
                  <X className="w-4 h-4" />
                </button>
              </div>
              <div>
              ...
              <button
                ...
                className="w-full py-1.5 bg-emerald-600 hover:bg-emerald-700 text-gray-900 font-medium text-xs rounded transition-all flex items-center justify-center gap-1"
              >
          ...
          {isEditing && selectedNode && (
            <div className="space-y-3 bg-white p-3 rounded border border-blue-200 shadow-sm animate-fadeIn">
              <div className="flex justify-between items-center">
                ...
                <button onClick={() => setIsEditing(false)} className="text-gray-500 hover:text-slate-600">
                  <X className="w-4 h-4" />
                </button>
              </div>
              <div>
              ...
              <button
                ...
                className="w-full py-1.5 bg-blue-600 hover:bg-blue-700 text-gray-900 font-medium text-xs rounded transition-all flex items-center justify-center gap-1"
              >
          ...
          <div className="mt-5 pt-4 border-t border-slate-200">
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 rounded-xl p-3.5 space-y-3">
                ...
                <button
                  ...
                  className={`flex-1 py-1.5 px-3 rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 transition-all ${
                    isRecording 
                      ...
                      : 'bg-indigo-600 hover:bg-indigo-700 text-gray-900 shadow-sm'
                  }`}
                >
                  {isRecording ? (
                    <>
              ...
              <button
                ...
                className="w-full py-2 bg-white hover:bg-gray-50 disabled:bg-slate-300 text-gray-900 font-bold text-xs rounded-lg transition-all flex items-center justify-center gap-1.5 shadow-sm"
              >
                {isProcessingAI ? (
                  <>
        ...
        <div className="mt-4 pt-3 border-t border-slate-200/60 text-[10px] text-gray-500 flex items-center gap-1.5 leading-normal">
